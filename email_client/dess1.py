...
class EmailApp:
    ...
    def build_ui(self):
        ...
        ctk.CTkLabel(self.sidebar, text="Ordner:").pack(pady=(20, 5))
        ctk.CTkButton(self.sidebar, text="Inbox", command=lambda: self.load_folder("INBOX")).pack(pady=2)
        ctk.CTkButton(self.sidebar, text="Sent", command=lambda: self.load_folder("Sent")).pack(pady=2)
        ctk.CTkButton(self.sidebar, text="Spam", command=lambda: self.load_folder("Spam")).pack(pady=2)
        ctk.CTkButton(self.sidebar, text="Trash", command=lambda: self.load_folder("Trash")).pack(pady=2)
        ctk.CTkLabel(self.sidebar, text="Filter:").pack(pady=(20, 5))
        ctk.CTkButton(self.sidebar, text="Ungelesen", command=self.filter_unread).pack(pady=2)
        ctk.CTkButton(self.sidebar, text="Mit Anhang", command=self.filter_attachments).pack(pady=2)
        ctk.CTkButton(self.sidebar, text="Heute", command=self.filter_today).pack(pady=2)
